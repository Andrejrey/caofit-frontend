...
const Loading = () => {
  return (
    <div className="h-screen flex flex-col justify-center items-center bg-LoginBg bg-cover bg-right">
      <div className="w-[300px] h-[330px] flex flex-col items-center justify-center bg-second rounded-lg">
        <div className="flex flex-row p-1 items-center mb-5 text-white text-4xl font-semibold">
        ...
        <div role="status" className="flex flex-col items-center">
          <div>
            <svg
              aria-hidden="true"
              className="w-32 h-32 mr-2 text-white animate-spin fill-first"
              viewBox="0 0 100 101"
              fill="none"
          ...
          <div className="mt-3 text-white rounded-lg">
